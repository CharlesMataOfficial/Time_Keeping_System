    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('schedule_group', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='users', to='attendance.schedulegroup', verbose_name='Schedule Group')),
                ('time_preset', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='legacy_users', to='attendance.timepreset', verbose_name='Legacy Schedule Preset')),
            ],
            options={
                'verbose_name': 'User',
        ...
        migrations.AddField(
            ...
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='default_for_groups', to='attendance.timepreset'),
        ),
        migrations.CreateModel(
            name='DayOverride',
            fields=[
                ...
                ('time_preset', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='used_in_overrides', to='attendance.timepreset')),
            ],
            options={
